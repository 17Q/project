...
# fixed and added multi-domain check support  for Patriot - 8/21


import re

from patriotscrapers import cfScraper
from patriotscrapers import parse_qs, urljoin, urlparse, urlencode, quote_plus
from patriotscrapers.modules import cleantitle, client, debrid, log_utils, source_utils
