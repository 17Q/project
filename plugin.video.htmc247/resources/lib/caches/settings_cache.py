...
class SettingsCache:
	def get(self, setting_id):
		try:
			...
			setting_id = setting_id.replace('htmc247.', '')
	...
	def set_memory_cache(self, setting_id, setting_value):
		kodi_utils.set_property('htmc247.%s' % setting_id, setting_value)

	def delete_memory_cache(self, setting_id):
		clear_property('htmc247.%s' % setting_id)
...
def set_boolean(params):
	...
	set_setting(setting, boolean_dict[get_setting('htmc247.%s' % setting)])

def set_string(params):
	current_value = get_setting('htmc247.%s' % params['setting_id'])
...
def set_path(params):
	...
	new_value = kodi_utils.kodi_dialog().browse(browse_mode, '', '', defaultt=get_setting('htmc247.%s' % setting_id))
	set_setting(setting_id, new_value)
...
def set_source_folder_path(params):
	setting_id = params['setting_id']
	current_setting = get_setting('htmc247.%s' % setting_id)
...
#===============================================================================#
#==================== General
{'setting_id': 'auto_start_htmc247', 'setting_type': 'boolean', 'setting_default': 'false'},
{'setting_id': 'addon_icon_choice', 'setting_type': 'string', 'setting_default': 'resources/media/addon_icons/htmc247_icon_01.png'},
...
{'setting_id': 'update.username', 'setting_type': 'string', 'setting_default': '17Q'},
{'setting_id': 'update.location', 'setting_type': 'string', 'setting_default': '17Q.github.io'},
#==================== Watched Indicators
{'setting_id': 'watched_indicators', 'setting_type': 'action', 'setting_default': '0', 'settings_options': {'0': 'Htmc 247', '1': 'Trakt'}},
#======+============= Trakt Cache
...
#==================== Downloads
{'setting_id': 'movie_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.htmc247/Movies Downloads/', 'browse_mode': '0'},
{'setting_id': 'tvshow_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.htmc247/TV Show Downloads/', 'browse_mode': '0'},
{'setting_id': 'premium_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.htmc247/Premium Downloads/', 'browse_mode': '0'},
{'setting_id': 'image_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.htmc247/Image Downloads/', 'browse_mode': '0'},
...
{'setting_id': 'nextep.include_unwatched', 'setting_type': 'action', 'setting_default': '0', 'settings_options': {'0': 'None', '1': 'Watchlist', '2': 'HtmcList', '3': 'Both'}},
...
{'setting_id': 'trakt.client', 'setting_type': 'string', 'setting_default': '27f7226ab30f872800c0d31ba18400e71dd0916a3163f5c2989d6456dfe2e0ca'},
{'setting_id': 'trakt.secret', 'setting_type': 'string', 'setting_default': 'c3d95e46398da08fdd969b4e7ef2d4c68dcf3397a1fffd86f47a30d3b912195f'},
#==================== TMDb API
{'setting_id': 'tmdb_api', 'setting_type': 'string', 'setting_default': '6e6a68c545dffdce0e054d1060fdd6e0'},
#==================== TMDb Lists
...
# {'setting_id': 'tmdb.token', 'setting_type': 'string', 'setting_default': '253f8ed49b19369843827dc928d136ed'},
# {'setting_id': 'tmdb.account_id', 'setting_type': 'string', 'setting_default': '253f8ed49b19369843827dc928d136ed'},
#==================== OMDb
...
{'setting_id': 'results_quality_movie', 'setting_type': 'string', 'setting_default': 'SD, 720p, 1080p'},
...
{'setting_id': 'stinger_alert.window_percentage', 'setting_type': 'action', 'setting_default': '90', 'min_value': '70', 'max_value': '99'},
...
{'setting_id': 'results_quality_episode', 'setting_type': 'string', 'setting_default': 'SD, 720p, 1080p'},
...
{'setting_id': 'autoscrape_next_episode', 'setting_type': 'boolean', 'setting_default': 'true'},
...
{'setting_id': 'addon_icon_choice_name', 'setting_type': 'string', 'setting_default': 'htmc247_icon_01'},
