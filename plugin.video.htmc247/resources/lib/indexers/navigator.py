...
class Navigator:
	def __init__(self, params):
		...
		self.category_name = self.params_get('name', 'Htmc 247')
	...
	def tools(self):
		...
		if get_setting('htmc247.external_scraper.module') not in ('empty_setting', ''):
		...
		if get_setting('htmc247.use_viewtypes', 'true') == 'true' and not get_setting('htmc247.manual_viewtypes', 'false') == 'true':
	...
	def changelog_utils(self):
		...
		htmc247_clogpath = k.translate_path('special://home/addons/plugin.video.htmc247/resources/text/changelog.txt')
		self.add({'mode': 'show_text', 'heading': 'Changelog', 'file': htmc247_clogpath, 'font_size': 'large', 'isFolder': 'false'}, 'Changelog', 'lists')
	...
	def exit_media_menu(self):
		params = k.get_property('htmc247.exit_params')
		if params: return k.container_refresh_input(params)

	def tips(self):
		tips_location = 'special://home/addons/plugin.video.htmc247/resources/text/tips'
