...
class Movies:
	...
	def fetch_list(self):
		...
		try:
			...
			if page_no == 1 and not self.is_external: kodi_utils.set_property('htmc247.exit_params', kodi_utils.folder_path())
	...
	def build_movie_content(self, _position, _id):
		try:
			...
			set_properties({
				...
				'htmc247.extras_params': extras_params,
				'htmc247.options_params': options_params,
				'htmc247.playback_options_params': playback_options_params,
				'htmc247.browse_movie_set_params': browse_movie_set_params,
				'htmc247.browse_recommended_params': browse_recommended_params,
				'htmc247.browse_more_like_this_params': browse_more_like_this_params,
				'htmc247.browse_in_trakt_list_params': browse_in_trakt_list_params,
				'htmc247.trakt_manager_params': trakt_manager_params,
				'htmc247.personal_manager_params': personal_manager_params,
				'htmc247.tmdb_manager_params': tmdb_manager_params,
				'htmc247.favorites_manager_params': favorites_manager_params
				})
	...
	def worker(self):
		...
		self.watched_title = 'Trakt' if self.watched_indicators == 1 else 'Htmc 247'
