...
def movies():
	items = [
	{
		...
		'thumbnail': plugin.get_media_icon('most-voted'),
		'fanart': plugin.get_addon_fanart(),
		'context_menu': [
	...
	},
	{
		...
		'thumbnail': plugin.get_media_icon('in-theaters'),
		'fanart': plugin.get_addon_fanart(),
		'context_menu': [
	...
	},
	{
		...
		'thumbnail': plugin.get_media_icon('most-popular'),
		'fanart': plugin.get_addon_fanart(),
		'context_menu': [
	...
	},
	{
		...
		'thumbnail': plugin.get_media_icon('highly-rated'),
		'fanart': plugin.get_addon_fanart(),
		'context_menu': [
	...
	},
	{
		...
		'thumbnail': plugin.get_media_icon('userlists'),
		'fanart': plugin.get_addon_fanart(),
		'context_menu': [
...
def tv():
	items = [
	{
		...
		'thumbnail': plugin.get_media_icon('airing-today'),
		'fanart': plugin.get_addon_fanart()
	},
	{
		'label': 'Popular (TMDB)',
