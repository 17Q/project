...
ORDER = ['easynews-fen',
         'fanart-patriot','fanart-theoath',
         'fanart-metadatautils', 'fanart-premiumizer', 'fanart-realizer',
         'fanart-seren', 'fanart-tmdbhelper',
         'fanart-venom',
         'furk-fen',
         'imdb-patriot','imdb-theoath', 'imdb-premiumizer',
         'imdb-realizer', 'imdb-venom',
         'kitsu-wonderfulsubs',
         ...
         'login-eis', 'tmdb-gaia',
         'tmdb-patriot','tmdb-theoath', 'tmdb-fen', 'tmdb-metadatautils',
         'tmdb-openinfo', 'tmdb-openmeta', 'tmdb-premiumizer', 'tmdb-realizer',
         'tmdb-seren', 'tmdb-tmdbhelper',
         'tmdb-venom',
...
LOGINID = {
    ...
    'tmdb-metadatautils': {
        ...
        'activate' : ''},
    'fanart-patriot': {
        'name'     : 'Fanart.tv - Patriot',
        'plugin'   : 'plugin.video.patriot',
        'saved'    : 'fanart-patriot',
        ...
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'patriot_fanart'),
    ...
    'tmdb-patriot': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.patriot', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.patriot', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'patriot_tmdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.patriot', 'settings.xml'),
        'default'  : 'tm.user',
        'data'     : ['tm.user'],
        'activate' : ''},
    'imdb-patriot': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.patriot', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.patriot', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'patriot_imdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.patriot', 'settings.xml'),
        'default'  : 'imdb.user',
        'data'     : ['imdb.user'],
        'activate' : ''},
    'fanart-theoath': {
        'name'     : 'Fanart.tv - The Oath',
        'plugin'   : 'plugin.video.theoath',
        'saved'    : 'fanart-theoath',
        ...
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'theoath_fanart'),
    ...
    'tmdb-theoath': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.theoath', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.theoath', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'theoath_tmdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.theoath', 'settings.xml'),
        'default'  : 'tm.user',
        'data'     : ['tm.user'],
        'activate' : ''},
    'imdb-theoath': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.theoath', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.theoath', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'theoath_imdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.theoath', 'settings.xml'),
        'default'  : 'imdb.user',
        'data'     : ['imdb.user'],
        'activate' : ''},
