...
#             self.addDirectoryItem(32037, 'calendar&url=progress', 'trakt.png', 'DefaultRecentlyAddedEpisodes.png', queue=True)
    ...
    def tools(self):
        ...
        self.addDirectoryItem('[B]Patriot[/B] : Clear Cache', 'clearCache', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B]Patriot[/B] : Clear Search History', 'clearCacheSearch', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B]Patriot[/B] : Clear Provider Sources', 'clearSources', 'tools.png', 'DefaultAddonProgram.png')
    ...
    def addDirectoryItem(self, name, query, thumb, icon, context=None, queue=False, isAction=True, isFolder=True):
        ...
        cm = []
        cm.append(('Patriot Settings', 'RunPlugin(%s?action=openSettings&query=(0,0))' % sysaddon))
