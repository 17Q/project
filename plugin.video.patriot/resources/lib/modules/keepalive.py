...
#  - fix for digest auth (inspired from urllib_request.py @ Python v2.4)
# Modified by Dirkjan Ochtman:
#  - import md5 function from a local util module


"""An HTTP handler for urllib_request that supports HTTP 1.1 and keepalive.
...
>>>
>>> fo = urllib_request.urlopen('http://www.python.org')
...
EXTRA ATTRIBUTES AND METHODS
  ...
  remain consistent with the normal urllib_request-returned objects:
  ...
  urllib_request tries to do clever things with error codes 301, 302, 401,
