...
INCLUDEPATRIOT = ADDON.getSetting('includepatriot')
...
def getCacheSize():
	...
	dbfiles   = [
		...
		(os.path.join(ADDOND, 'plugin.video.patriot', 'cache.db')),
		(os.path.join(ADDOND, 'plugin.video.patriot', 'cache.metadata.db')),
		(os.path.join(ADDOND, 'plugin.video.patriot', 'cache.providers.13.db')),
	...
	if INCLUDEVIDEO == 'true':
		...
		if INCLUDEALL == 'true': files = dbfiles
			...
			if INCLUDEPATRIOT == 'true':
				files.append(os.path.join(ADDOND, 'plugin.video.patriot', 'cache.db'))
				files.append(os.path.join(ADDOND, 'plugin.video.patriot', 'metadata.db'))
				files.append(os.path.join(ADDOND, 'plugin.video.patriot', 'providers.13.db'))
