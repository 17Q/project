...
INCLUDEPATRIOT      = wiz.getS('includepatriot')
...
def maintMenu(view=None):
    ...
    if includeall == 'true':
        ...
        includepatriot = 'true' if INCLUDEPATRIOT == 'true' else 'false'
    ...
    if includevid == 'true':
        ...
        addFile('--- Include Patriot: %s' % includepatriot.replace('true',on).replace('false',off), 'togglecache', 'includepatriot', icon=ICONMAINT, themeit=THEME6)
...
def toggleCache(state):
    cachelist = ['includevideo', 'includeall', 'includehtpctv', 'includeexegesis', 'includepatriot', 'includescrubsv2', 'includevenom', 'includejudaea', 'includeseren', 'includeexodusredux']
    titlelist = ['Include Video Addons', 'Include All Addons', 'Include htpcTV', 'Include Exegesis', 'Include Patriot', 'Include Scrubs v2', 'Include Venom', 'Include Judaea', 'Include Seren', 'Include Exodus Redux']
