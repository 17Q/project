...
def build_episode_list(params):
	...
	watched_title = 'Trakt' if watched_indicators == 1 else 'Patriot Light'
...
def build_single_episode(list_type, params={}):
	...
	if list_type == 'episode.next':
		...
		else: resformat, resinsert, list_type = '%Y-%m-%d %H:%M:%S', '2000-01-01 00:00:00', 'episode.next_patriotlight'
