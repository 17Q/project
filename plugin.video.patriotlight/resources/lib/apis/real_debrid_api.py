...
class RealDebridAPI:
	def __init__(self):
		self.client_ID = get_setting('patriotlight.rd.client_id', 'empty_setting')
		if self.client_ID in ('empty_setting', ''): self.client_ID = 'X245A4XAIBGVM'
		self.base_url = 'https://api.real-debrid.com/rest/1.0/'
		self.auth_url = 'https://api.real-debrid.com/oauth/v2/'
		self.token = get_setting('patriotlight.rd.token', 'empty_setting')
		self.secret = get_setting('patriotlight.rd.secret', 'empty_setting')
		self.refresh = get_setting('patriotlight.rd.refresh', 'empty_setting')
		self.device_code = ''
