...
class SettingsCache:
	def get(self, setting_id):
		try:
			...
			setting_id = setting_id.replace('patriotlight.', '')
	...
	def set_memory_cache(self, setting_id, setting_value):
		kodi_utils.set_property('patriotlight.%s' % setting_id, setting_value)

	def delete_memory_cache(self, setting_id):
		clear_property('patriotlight.%s' % setting_id)
...
def set_boolean(params):
	...
	set_setting(setting, boolean_dict[get_setting('patriotlight.%s' % setting)])

def set_string(params):
	current_value = get_setting('patriotlight.%s' % params['setting_id'])
...
def set_path(params):
	...
	new_value = kodi_utils.kodi_dialog().browse(browse_mode, '', '', defaultt=get_setting('patriotlight.%s' % setting_id))
	set_setting(setting_id, new_value)
...
def set_source_folder_path(params):
	setting_id = params['setting_id']
	current_setting = get_setting('patriotlight.%s' % setting_id)
...
#===============================================================================#
#==================== General
{'setting_id': 'auto_start_patriotlight', 'setting_type': 'boolean', 'setting_default': 'false'},
{'setting_id': 'addon_icon_choice', 'setting_type': 'string', 'setting_default': 'resources/media/addon_icons/patriotlight_icon_01.png'},
...
#==================== Watched Indicators
{'setting_id': 'watched_indicators', 'setting_type': 'action', 'setting_default': '0', 'settings_options': {'0': 'Patriot Light', '1': 'Trakt'}},
#======+============= Trakt Cache
...
#==================== Downloads
{'setting_id': 'movie_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.patriotlight/Movies Downloads/', 'browse_mode': '0'},
{'setting_id': 'tvshow_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.patriotlight/TV Show Downloads/', 'browse_mode': '0'},
{'setting_id': 'premium_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.patriotlight/Premium Downloads/', 'browse_mode': '0'},
{'setting_id': 'image_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.patriotlight/Image Downloads/', 'browse_mode': '0'},
...
{'setting_id': 'nextep.include_unwatched', 'setting_type': 'action', 'setting_default': '0', 'settings_options': {'0': 'None', '1': 'Watchlist', '2': 'PatriotList', '3': 'Both'}},
...
{'setting_id': 'trakt.client', 'setting_type': 'string', 'setting_default': 'cd5941ee1a73d08c7a57dd8114a2bab61e5ab4bf27721d8be9c822a2fbb823ef'},
{'setting_id': 'trakt.secret', 'setting_type': 'string', 'setting_default': 'ca0ac9534a83a5d1c508ebfbaecfd6e2e814152c440f344525cdd98afc6a6a79'},
#==================== TMDb API
...
{'setting_id': 'addon_icon_choice_name', 'setting_type': 'string', 'setting_default': 'patriotlight_icon_01'},
