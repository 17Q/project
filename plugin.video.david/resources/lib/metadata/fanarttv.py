...
api_key = fanarttv_default_api
blank_image_values = ('00', '', 'None', '')
default_fanart_meta = {'poster2': '', 'fanart2': '', 'banner': '', 'clearart': '', 'clearlogo2': '', 'landscape': '', 'discart': '', 'keyart': '', 'fanart_added': True}
default_fanart_nometa = {'poster2': '', 'fanart2': '', 'banner': '', 'clearart': '', 'clearlogo2': '', 'landscape': '', 'discart': '', 'keyart': '', 'fanart_added': False}
...
def parse_art(art, language, keyart=False):
	if not art: return ''
	try:
		if language == 'keyart':
