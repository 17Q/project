...
import urllib.error
import urllib.parse
from qscrapers.modules.control import setting as getSetting, notification
from qscrapers.modules.log_utils import LOGINFO
...
class Prowlarr:
    ...
    def pretty_print(self, value: any):
        xbmc.log('script.module.qscrapers' + str(value), LOGINFO)
